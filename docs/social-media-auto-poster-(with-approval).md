...
## Overview
This is an exported n8n workflow for **Social Media Auto-Poster (with Approval)**.
...
- **Slack Approval Wait** (n8n-nodes-base.slack)
...
graph TD;
  ...
  "AI Social Media Creator" --> "Slack Approval Wait";
  "Slack Approval Wait" --> "Post to Twitter / X";
  "Slack Approval Wait" --> "Post to LinkedIn";
```
